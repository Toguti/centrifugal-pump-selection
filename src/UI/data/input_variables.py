header_second_line = ["Trecho Retilíneo", "Diferença de Altura", "Cotovelo 90° Raio Longo", "Cotovelo 90° Raio Médio", "Cotovelo 90° Raio Curto",
     ...
     "Válvula de Retenção Leve", "Válvula de Retenção Pesado", "Somatório Coef. K"]
