header_second_line = ["Índice", "De", "Para", "Vazão", "Trecho Retilíneo", "Cotovelo 90° Raio Longo", "Cotovelo 90° Raio Médio", "Cotovelo 90° Raio Curto",
     ...
     "Válvula de Retenção Leve", "Válvula de Retenção Pesado", "Somatório Coef. K","Botão"]

print(len(header_second_line))